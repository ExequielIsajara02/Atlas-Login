...
import laurel from "../assets/img/laurel.jpg";
...
const Form = () => {
  return (
    <div className="flex justify-center items-center w-3/5 mx-auto space-x-10 mt-10">
      ...
      <section className="shadow-md shadow-slate-700 w-1/2 flex flex-col justify-center items-center border mx-auto ml-4 pt-4 rounded-lg">
        <form className="w-full flex flex-col items-center mx-auto my-10">
          <h1 className="text-2xl text-slate-700 mb-2">Welcome Back!</h1>
          <img
            src={door3_remove}
            alt=""
            className="w-60 bg-slate-700 text-slate-700 rounded-t-md px-2 pt-2 hover:bg-yellow-700"
          />
          <div className="w-3/5 flex justify-center items-center px-8 p-2 rounded-md mx-5 shadow shadow-slate-800 hover:bg-blue-500 cursor-pointer hover:text-white">
            <img src={google_logo} alt="" className="bg-white w-8 rounded-md mr-2" />
            <a href="" className="font-bold">Sign In with Google</a>
          
          </div>
          <img src={laurel} alt="" className="h-20 mb-4 mt-2"/>
        </form>
      </section>
    </div>
  );
